...
var style_PaperMillsTOP20Rice50Km_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Rice 50KM");
    var labelText = "";
    size = 0;
    ...
    if (value >= 10389265.000000 && value <= 10389265.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.0 + size, points: 3,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(43,131,30,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
                    } else if (value >= 10389265.000000 && value <= 16337229.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16337229.000000 && value <= 20030320.800000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.000000000000002 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20030320.800000 && value <= 20966333.800000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.000000000000002 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20966333.800000 && value <= 27539165.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.000000000000002 + size, points: 3,
